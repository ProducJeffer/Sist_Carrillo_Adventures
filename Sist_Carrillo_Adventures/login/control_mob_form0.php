...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_sc_field_0" style="<?php echo $sStyleHidden_sc_field_0; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_sc_field_0"><?php echo $this->nm_new_label['sc_field_0']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_sc_field_1" style="<?php echo $sStyleHidden_sc_field_1; ?>;"> <span class="scFormLabelOddFormat" style=";" ><span id="id_label_sc_field_1"><?php echo $this->nm_new_label['sc_field_1']; ?></span></span><br>
