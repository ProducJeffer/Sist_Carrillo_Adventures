...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags("Sistema Carrillo Adventures"); } ?></TITLE>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""; } else { echo "Sistema Carrillo Adventures"; } ?></span></td>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['sc_field_0'] = "Nombre usuario";
    }
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_sc_field_0" style="<?php echo $sStyleHidden_sc_field_0; ?>;"><span id="id_label_sc_field_0"><?php echo $this->nm_new_label['sc_field_0']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_sc_field_0" style="<?php echo $sStyleHidden_sc_field_0; ?>;">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['sc_field_1'] = "Contraseña";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<input type="hidden" name="sc_field_1" value="<?php echo NM_encode_input($sc_field_1) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_sc_field_1" style="<?php echo $sStyleHidden_sc_field_1; ?>;"><span id="id_label_sc_field_1"><?php echo $this->nm_new_label['sc_field_1']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_sc_field_1" style="<?php echo $sStyleHidden_sc_field_1; ?>;">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sc_field_1"]) &&  $this->nmgp_cmp_readonly["sc_field_1"] == "on") { ?>
<input type="hidden" name="sc_field_1" value="">
<?php } else { ?>
<span id="id_read_on_sc_field_1" class="sc-ui-readonly-sc_field_1" style=";<?php echo $sStyleReadLab_sc_field_1; ?>"><?php echo NM_encode_input($this->sc_field_1); ?></span><span id="id_read_off_sc_field_1" style="white-space: nowrap;<?php echo $sStyleReadInp_sc_field_1; ?>"><input class="sc-js-input scFormObjectOdd" style=";" id="id_sc_field_sc_field_1" type=password name="sc_field_1" value="" 
 size=10 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</TD>
   <?php }?>
