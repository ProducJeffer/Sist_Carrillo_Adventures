...
class UploadHandler
{
    ...
    private function handle_file_upload($uploaded_file, $name, $size, $type, $error) {
        ...
        if ($bRedim)
        {
            $file->sc_thumb_prot = $file->sc_random . 'thumb_' . $sUploadFileNameProt;
            $file->sc_thumb      = $file->sc_random . 'thumb_' . $sUploadFileNameOrig;
        }
        else
        {
        ...
        if (!$error && $file->name) {
            ...
            */
            ...
            if ($bRedim)
            {
                ...
                $sc_obj_img = new nm_trata_img($this->options['upload_dir'] . $file->sc_random);
